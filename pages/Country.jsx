                      ...
                      <div className="child right-detail">
                        ...
                        <div className="sub-detail">
                          <div className="child left">
                            ...
                            <p><b>Capital:</b>&nbsp; {country.capital.length !== 0 ? country.capital.join(', ') : 'N/A'}</p>
                          </div>

                          <div className="child right">
                            <p><b>Top Level Domain:</b>&nbsp; {country?.tld}</p>
                            <p><b>Currencies:</b>&nbsp; {Object.keys(country.currencies).length > 0 ? Object.values(country.currencies).map(curr => curr.name).join(', ') : 'N/A'}</p>
                            <p><b>Language:</b>&nbsp; {Object.keys(country.languages).length > 0 ? Object.values(country.languages).join(', ') : 'N/A'}</p>
                          </div>
                        </div>
